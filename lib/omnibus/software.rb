...
module Omnibus
  class Software
    ...
    def with_glibc_version(env = {})
      ...
      env['CFLAGS'] = "#{env['CFLAGS']} -include /usr/local/glibc_version_header/version_headers/#{glibc_arch}/force_link_glibc_#{glibc_version}.h -static-libgcc -static-libstdc++"
      env['CPPFLAGS'] = "#{env['CPPFLAGS']} -include /usr/local/glibc_version_header/version_headers/#{glibc_arch}/force_link_glibc_#{glibc_version}.h -static-libgcc -static-libstdc++"
      env['CXXFLAGS'] = "#{env['CXXFLAGS']} -include /usr/local/glibc_version_header/version_headers/#{glibc_arch}/force_link_glibc_#{glibc_version}.h -static-libgcc -static-libstdc++"
